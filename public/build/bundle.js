...
var app = (function () {
    ...
    const file = "src/components/atoms/Message.svelte";
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			p1 = element("p");
    			t2 = text(/*text*/ ctx[1]);
    			attr_dev(p0, "class", "title message__title svelte-1rmqrt7");
    			add_location(p0, file, 16, 2, 293);
    			attr_dev(p1, "class", "message__text svelte-1rmqrt7");
    			add_location(p1, file, 17, 2, 339);
    			attr_dev(div, "class", div_class_value = "nes-container is-dark message " + (/*title*/ ctx[0] && "with-title") + " svelte-1rmqrt7");
    			add_location(div, file, 15, 0, 223);
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*title*/ 1 && div_class_value !== (div_class_value = "nes-container is-dark message " + (/*title*/ ctx[0] && "with-title") + " svelte-1rmqrt7")) {
    ...
    class Message extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, safe_not_equal, { title: 0, text: 1 });
    ...
    const file$1 = "src/components/atoms/SocialSection.svelte";
    ...
    const file$2 = "src/components/atoms/ItemWithDescription.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$2, 18, 2, 225);
    			add_location(p, file$2, 21, 2, 327);
    			attr_dev(li, "class", "point svelte-1j02ay7");
    			add_location(li, file$2, 17, 0, 204);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$3 = "src/components/molecules/ListWithLinks.svelte";
    ...
    class ListWithLinks extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { title: 0, description: 1, items: 2 });
    ...
    function create_fragment$4(ctx) {
    	...
    	listwithlinks1 = new ListWithLinks({
    			props: {
    				...
    				items: /*workExperiencesItems*/ ctx[2]
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$4, 56, 4, 1864);
    			attr_dev(a, "href", "https://svelte.dev/tutorial");
    			add_location(a, file$4, 59, 6, 1917);
    			add_location(p, file$4, 57, 4, 1891);
    			attr_dev(div, "class", "container");
    			add_location(div, file$4, 55, 2, 1836);
    			add_location(main, file$4, 54, 0, 1827);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(div, t8);
    			mount_component(socialsection, div, null);
    			append_dev(div, t9);
    			mount_component(listwithlinks0, div, null);
    			append_dev(div, t10);
    			mount_component(listwithlinks1, div, null);
    			current = true;
    		},
    		p: function update(ctx, [dirty]) {
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	return [name, openSourceItems, workExperiencesItems];
    }
